page 95404 "Approved Sub Award Addendum"
{
    ApplicationArea = All;
    Caption = 'Approved Sub Award Addendum';
    PageType = Card;
    ...
    SourceTableView = where(Status = const(Approved), Extended = const(false));
                        ...
                        action(Post)
                        {
                            ...
                            begin
                                ...
                                IF Subaward.FindSet() then begin
                                    ...
                                    if Subaward."Addendum Counter" = 0 then begin
                                        New."Original Sub Award Contract" := Rec."Sub Award No";
                                        Subaward."Addendum Counter" := Subaward."Addendum Counter" + 1;
                                        Subaward."Renewed Sub Award Contract No" := Rec."No.";
                                    end;
