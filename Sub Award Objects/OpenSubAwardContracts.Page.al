page 65165 "Open Sub Award Contracts"
{
    ApplicationArea = All;
    CardPageID = "Sub Award Contract Card";
    DeleteAllowed = false;
    Caption = 'Open Sub Award Contracts';
    PageType = List;
    SourceTable = "Sub Award";
    SourceTableView = where("Document Status" = filter(Open));
    UsageCategory = Lists;
    Editable = false;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the Under Contracting Status field.';
                }
            }
        }
    }
