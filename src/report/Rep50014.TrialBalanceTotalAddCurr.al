report 50014 "Trial Balance Total Add Curr"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("No.") where("Account Type" = const(Posting), "Add.-Currency Balance at Date" = filter(<> 0));
            ...
            begin
                ...
                if GLAccount.FindSet() then begin
                    repeat
                        ...
                        //     Clear(GLAccount."Add.-Currency Balance at Date");
                        //     BankAcc.CalcFields(Balance);
                        //     GLAccount."Add.-Currency Balance at Date" := BankAcc.Balance;

                        //     if GLAccount."Add.-Currency Balance at Date" > 0 then begin
                        //         DebTotal := DebTotal + GLAccount."Add.-Currency Balance at Date";
                        //     end
                        //     else if GLAccount."Add.-Currency Balance at Date" < 0 then begin
                        //         CredTotal := CredTotal + Abs(GLAccount."Add.-Currency Balance at Date");
                        //     end;
                        // end else begin
                        //     if GLAccount."Add.-Currency Balance at Date" <> 0 then begin
                        //         if GLAccount."Add.-Currency Balance at Date" > 0 then begin
    ...
    var
        ...
        Net_ChangeCaptionLbl: Label 'Additional-Currency Net Change';
