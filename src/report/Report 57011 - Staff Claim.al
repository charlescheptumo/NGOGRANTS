...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Staff Claim2.rdlc';
    ...
    dataset
    {
        dataitem(Payments; Payments)
        {
            ...
            dataitem("PV Lines"; "PV Lines")
            {
                ...
                column(CurrencyCode_PVLines; "PV Lines"."Currency Code")
                {
                }
                ...
                column(ShortcutDimension3Code_PVLines; "PV Lines"."Shortcut Dimension 3 Code")
                {
                }
            ...
            begin
                ...
                PaymentMgt.FormatNoText(NumberText, Payments."Total Amount", CurrencyCodeText);
