report 50020 "NITA Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NITAReporting.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        ...
        dataitem("Assignment Matrix-X"; "Assignment Matrix-X")
        {
            ...
            column(NATIONAL_SOCIAL_SECURITY_FUND__; Uppercase('National Industial Training Authority '))
            {
            }
            ...
            column(NATIONAL_SOCIAL_SECURITY_FUND___Control28; Uppercase('National Industial Training Authority '))
            {
            }
