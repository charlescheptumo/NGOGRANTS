report 50015 "Create Timesheets"
{
            ...
            dataitem(Resource; Resource)
            {
                ...
                begin
                    ...
                    if CheckExistingPeriods() then begin
                        ...
                        // PayrollPeriodX.SetRange("Starting Date", CalcDate('-CM', StartingDate));
                        // PayrollPeriodX.FindFirst();
                        ...
                        TimeSheetHeader.Description := GetWeekNumber(StartingDate);
                        TimeSheetHeader."Pay Period" := CalcDate('-CM', StartingDate);
    ...
    local procedure GetWeekNumber(StartingDate: Date): Text
    var
        DateRec: Record Date;
    begin
