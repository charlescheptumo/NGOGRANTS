report 99098 "Trial Balance 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/TrialBalance2.rdlc';
    ...
    var
        ...
        Trial_BalanceCaptionLbl: Label 'Trial Balance 2';
        CurrReport_PAGENOCaptionLbl: Label 'Page';
        // Net_ChangeCaptionLbl: Label 'Net Change';
        Net_ChangeCaptionLbl: Label '';
        BalanceCaptionLbl: Label 'Balance';
        PADSTR_____G_L_Account__Indentation___2___G_L_Account__NameCaptionLbl: Label 'Name';
        G_L_Account___Net_Change_CaptionLbl: Label 'Debit (USD)';
        G_L_Account___Net_Change__Control22CaptionLbl: Label 'Credit (USD)';
