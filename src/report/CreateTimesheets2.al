report 99099 "Create Time Sheets 2"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Create Time Sheets 2';
    ProcessingOnly = true;
    UsageCategory = Tasks;
            ...
            dataitem(Resource; Resource)
            {
                ...
                begin
                    ...
                    if CheckExistingPeriods() then begin
                        ...
                        TimeSheetHeader."Pay Period" := PayrollPeriodX."Starting Date";
    ...
    // begin
    //     if Date2DWY(StartingDate, 1) <> (PayPeriod.Closed <> true) + 1 then
    //         Error(Text010, ResourcesSetup."Time Sheet First Weekday");
    // end;
