report 50011 "Trial Balance Total2"
{
    ApplicationArea = All;
    Caption = 'Trial Balance Total2';
    RDLCLayout = './Layouts/Trial Balance Total21.rdlc';
            ...
            begin
                ...
                if GLAccount.FindSet() then begin
                    repeat
                        ...
                        // Message(' GLAccount."Balance at Date" is %1', GLAccount."Balance at Date");
                        if GLAccount."Balance at Date" <> 0 then begin
                            if GLAccount."Balance at Date" > 0 then begin
                                DebTotal := DebTotal + GLAccount."Balance at Date";
                                //    Message(format(DebTotal));
                            end
