report 50006 "Project Analysis Cust"
{
    ApplicationArea = All;
    Caption = 'Project Analysis';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Layout/ProjectAnalysis.rdlc';
    ...
    dataset
    {
        dataitem(Job; Job)
        {
            ...
            RequestFilterFields = "No.", "Posting Date Filter", "Starting Date", "Planning Date Filter";
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field("AmountField[1]"; AmountField[1])
                    {
                        ...
                        OptionCaption = ' ,Budget Cost,Usage Cost,Invoiced Cost';
                        ToolTip = 'Specifies that you want to use a combination of the available Amount fields to create your own analysis.';
                    }
