report 50001 "Bank Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/BankAccountStatement.rdlc';
    ...
    dataset
    {
        dataitem("Bank Account Statement"; "Bank Account Statement")
        {
            ...
            begin
                ...
                ApprovalEntries.SetRange("Table ID", 275);
                ApprovalEntries.SetRange("Document No.", "Statement No.");
