report 50004 "Job - Planning Lines Cust"
{

    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ProjectPlanningLines.rdlc';
    ...
    dataset
    {
        dataitem(Job; Job)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(JobPlannLineStartDtCptnLbl; JobPlannLineStartDtCptnLbl)
                {
                }
            ...
            dataitem("Job Task"; "Job Task")
            {
                ...
                dataitem("Job Planning Line"; "Job Planning Line")
                {
                    ...
                    column(StartDate_JobPlanningLine; Format("Starting Date"))
                    {
                    }
    ...
    labels
    {
        ...
        JobTaskNo_JobTaskCptn = 'Project Activity No.';
    }
    ...
    var
        ...
        JobPlannLineStartDtCptnLbl: Label 'Start Date';
