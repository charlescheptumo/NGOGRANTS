report 65021 "Grant Funding Proposal"
{
    ...
    dataset
    {
        dataitem("Grant Funding Application"; "Grant Funding Application")
        {
            ...
            column(GrantAdminTeamCode_GrantFundingApplication; "Grant Funding Application"."Application No")
            {
            }
            ...
            dataitem("Grant Research Objectives"; "Grant Research Objectives")
            {
                ...
                column(ResearchProgram_GrantResearchObjectives; "Grant Research Objectives"."Entry No")
                {
                }
                column(ProjectArea_GrantResearchObjectives; "Grant Research Objectives"."Entry No")
                {
                }
            }
            ...
            dataitem("Grant Admin Tasks"; "Grant Admin Tasks")
            {
                ...
                column(SourecDocumentNo_GrantAdminTasks; "Grant Admin Tasks"."No.")
                {
                }
