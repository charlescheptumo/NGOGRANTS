report 99108 "Purchase Order"
{
    WordLayout = './Layouts/StandardPurchaseOrder.docx';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            begin
                ...
                CurrReport.Language := OnLanguage.GetLanguageIdOrDefault("Language Code");
