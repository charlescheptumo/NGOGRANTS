report 50007 "Project Actual To Budget"
{
    ApplicationArea = All;
    Caption = 'Project Actual To Budget2';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Layout/ProjectActualToBudget.rdlc';
    ...
    var
        ...
        UsageCaptionLbl: Label 'Actual Spent';
        DifferenceCaptionLbl: Label 'Variance';
