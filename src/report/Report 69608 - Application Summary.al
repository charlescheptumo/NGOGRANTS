    ...
    dataset
    {
        dataitem(Applicant; "Job Applications")
        {
            ...
            dataitem("Job Applicants Qualification"; "Application Qualification")
            {
                ...
                column(Graduation_Year_JobApplicantsQualification; Format("Job Applicants Qualification"."Graduation Year"))
                {
                }
                ...
                column(MembershipType_JobApplicantsQualification; "Job Applicants Qualification"."Membership Type")
                {
                }
                column(Country_JobApplicantsQualification; "Job Applicants Qualification".Country)
                {
                }
                column(CompletionYear_JobApplicantsQualification; "Job Applicants Qualification"."Completion Year")
                {
                }
                column(Institution_Company__JobApplication; "Job Applicants Qualification"."Institution/Company")
                {
                }
                column(Membership_Type__JobApplication; "Job Applicants Qualification"."Membership Type")
                {
                }
                column(Membership_Registration_No__JobApplication; "Job Applicants Qualification"."Membership Registration No")
                {
                }
                column(Completion_Year__JobApplication; "Job Applicants Qualification"."Completion Year")
                {
                }
                column(Country__JobApplication; "Job Applicants Qualification".Country)
                {
                }
            }
            ...
            var
                ApplQual: Record "Application Qualification";
            begin
                if ApplQual.Ongoing = true then begin
                    // Format(ApplQual."To Date", 0, '<year>');
                    Clear(ApplQual."To Date");
                end
            end;
        }
    }
