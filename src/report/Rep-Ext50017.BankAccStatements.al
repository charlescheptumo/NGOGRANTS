reportextension 50017 "Bank Acc Statements" extends "Bank Account Statement"
{
    dataset
    {
        add("Bank Account Statement")
        {
        ...
        modify("Bank Account Statement")
        {
            // modify the new, added field
            trigger OnBeforeAfterGetRecord()
            begin
                //Approvals
                docno := "Bank Account Statement"."Bank Account No." + ' ' + "Bank Account Statement"."Statement No.";
