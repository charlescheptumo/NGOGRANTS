...
//             }
//         }
//         dataitem(UnknownTable69007;UnknownTable69007)
//         {
...
//                 end;
//             }
//             dataitem(UnknownTable69005;UnknownTable69005)
//             {
...
//                 end;
//             }
//             dataitem(Employer;UnknownTable69006)
//             {
...
//             end;
//         }
//         dataitem(UnknownTable69006;UnknownTable69006)
//         {
//             DataItemTableView = sorting(Code) where(Loan=const(No));
...
//             end;
//         }
//         dataitem(LoansRec;UnknownTable69006)
//         {
//             DataItemTableView = sorting(Code) where(Loan=const(Yes));
...
//             end;
//         }
//         dataitem(ExternalLoans;UnknownTable69006)
//         {
//             DataItemTableView = sorting(Code) where(Loan=const(Yes));
...
//         LineNumber: Integer;
//         TotalBasic: Decimal;
//         PayrollPeriod: Record UnknownRecord69000;
//         PostingGroup: Record UnknownRecord69007;
//         TaxAccount: Code[10];
//         SalariesAcc: Code[10];
//         PayablesAcc: Code[20];
//         First: Code[10];
...
//         AssignmentMat: Record UnknownRecord69009;
...
//         EarningsCopy: Record UnknownRecord69005;
//         LoanApp: Record UnknownRecord69011;
//         EmpAccMap: Record UnknownRecord69050;
//         PGMapping: Record UnknownRecord69021;
//         Loanproduct: Record UnknownRecord69010;
//         EmpName: Text[70];
...
//         PayrollHeader: Record UnknownRecord69030;
...
//     var
//         TaxTable: Record UnknownRecord69004;
//         TotalTax: Decimal;
//         Tax: Decimal;
//         EndTax: Boolean;
//     begin
...
//     procedure GetPayPeriod(var PayPeriods: Record UnknownRecord69000)
//     begin
...
//     var
//         PayPeriodRec: Record UnknownRecord69000;
//     begin
