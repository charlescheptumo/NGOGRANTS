...
Table 69130 "Leave Types"
{
    ...
    fields
    {
        ...
        field(15;"Posting Type";Option)
        {
            ...
            OptionCaption = 'Annual,Compassionate,Marternity,Parternity,Sick Leave,Study Leave,Sports Leave,Unpaid Leave,Terminal Leave';
            OptionMembers = Annual,Compassionate,Marternity,Parternity,"Sick Leave","Study Leave","Sports Leave","Unpaid Leave","Terminal Leave";
        }
    }
