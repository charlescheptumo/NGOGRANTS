...
Table 69708 "Candidate Selection Panelist"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Panelist,Chairperson,Secretary,Consultant';
        ...
        {
            tablerelation = Employee."No." where(status = const(Active), "Employee Type" = const(APHF));
            DataClassification = ToBeClassified;
            trigger onValidate()
            begin
                if "Staff No." <> '' then
