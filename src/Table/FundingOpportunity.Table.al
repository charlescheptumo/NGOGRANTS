...
Table 65021 "Funding Opportunity"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = Contact;//where ("Contact Type"=const("Funding Agency"));
            ...
            begin
                ...
                if Contacts.Find('-') then begin
                    ...
                    "Funding Agency Country" := Contacts."Country/Region Code";
                    "Funding Agency Name" := Contacts.Name;
                    "Funding Agency Phone" := Contacts."Phone No.";
                    "Funding Agency Email" := Contacts."E-Mail";
                    "Funding Agency City" := Contacts.City;
                end;
            end;
        }
        ...
        field(28; "Project Duration"; DateFormula)
        {
            ...
            begin
                if "Release Date" = 0D then
                    exit;
                if Format("Project Duration") = '' then
                    exit;

                "Expiration Date" := CalcDate("Project Duration", "Release Date");
            end;
        }
        ...
        field(99; "Funding Agency Country"; Text[30])
        {
            DataClassification = ToBeClassified;
        }
        field(100; "Grant Thematic Area"; Code[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Thematic Area";
        }
        field(101; Published; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(103; "Referenced Concept Note"; Code[20])
        {
            DataClassification = ToBeClassified;
            Enabled = true;
        ...
        field(117; "Estimated Award Duration"; DateFormula)
        {
            DataClassification = ToBeClassified;
            ...
            begin
                if "Expiration Date" = 0D then
                    exit;
                if Format("Estimated Award Duration") = '' then
                    exit;

                "Estimated Award Date" := CalcDate("Estimated Award Duration", "Expiration Date");
            end;
        }
        field(118; "Estimated Award Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(119; "Funding Agency Name"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(120; "Funding Agency Phone"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(121; "Funding Agency Email"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(122; "Funding Agency City"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Call No.", "Organization ID", "Issuing Organization")
        {
        }
    }
    ...
    begin
        if "Call No." = '' then begin
            ...
            "Call No." := NoSeriesMgt.GetNextNo(GrantsSetup."Grantor Nos", WorkDate(), true);
        end;
