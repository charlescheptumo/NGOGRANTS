...
Table 69619 "Recruitment Requisition Header"
{
    ...
    fields
    {
        ...
        field(5; "Position ID"; Code[30])
        {
            ...
            "Recruitment Planning Line"."Position ID";
            ...
            begin
                ...
                EPL.Reset();
                EPL.SetRange("Position ID", "Position ID");
                if EPL.FindFirst() then begin
                    "Staff Establishment" := EPL."Optimal Staffing";
                end;
            end;
        }
        ...
        field(61; "Contract Type"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Terms of Service".Code;
        }
        field(62; "Budget"; Enum "Recruitment Budget")
        {
            DataClassification = ToBeClassified;
        }
        field(63; "Contract Type2"; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = "Employee w. full benefit","Employee w. partial benefits","Contract worker";
            OptionCaption = 'Employee w. full benefit,Employee w. partial benefits, Contract worker';
        }
        field(64; Purpose; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        if "Document Type" = "document type"::"Job Vacancy" then begin
            ...
            if "Document No." = '' then
                "Document No." := NoSeriesMgt.GetNextNo(HumanResourcesSetup."Vacancy Nos.", Today, true);
            // NoSeriesMgt.InitSeries(HumanResourcesSetup."Training Deduction", xRec."No. Series", 0D, "Document No.", "No. Series");
            // NoSeriesMgt.InitSeries(HumanResourcesSetup."Vacancy Nos.", xRec."No. Series", 0D, "Document No.", "No. Series");
        ...
        if "Document Type" = "document type"::"Recruitment Requisition" then begin
            ...
            if "Document No." = '' then
                "Document No." := NoSeriesMgt.GetNextNo(HumanResourcesSetup."Recruitment Requsition Nos.", Today, true);
