...
Table 65019 "Grant Research Team"
{
    ...
    fields
    {
        ...
        field(4;"Primary Role";Code[30])
        {
            ...
            begin
                ...
                GrantsSetup.Reset;
                GrantsSetup.SetRange(GrantsSetup."Primary Role","Primary Role");
        ...
        field(11;"Lead Role";Boolean)
        {
            ...
            begin
                ...
                GrantResearchTeam.SetFilter("Researcher ID",'<>%1',"Researcher ID");
                GrantResearchTeam.SetRange("Grant Opportunity ID","Grant Opportunity ID");
                GrantResearchTeam.SetRange("Lead Role",true);
                if GrantResearchTeam.FindFirst then
                  Error('A Lead on this grant already Exists!');
            end;
        }
    }
    ...
    keys
    {
        key(Key1;"Grant Opportunity ID","Researcher ID")
        {
            Clustered = true;
        }
    }
