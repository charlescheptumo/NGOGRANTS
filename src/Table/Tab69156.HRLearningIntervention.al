...
Table 69156 "HR Learning Intervention"
{
   // LookupPageID = UnknownPage52091;
    ...
    fields
    {
        ...
        {
          //  CalcFormula = sum("Ethnic Background".Field73 where (Field74=field("Calendar Year")));
        ...
        {
           // CalcFormula = sum("Staff Est Plan Lines"."Department Name" where (Field25=field("Calendar Year")));
            FieldClass = FlowField;
        }
