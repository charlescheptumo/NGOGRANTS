...
Table 69686 "HR Screening Template"
{
    ...
    begin
        ...
        if "Template Type" = "template type"::"Application Submission" then begin
            ...
            if Code = '' then
                code := NoSeriesMgt.GetNextNo(HRSetup."Applicant Template Nos.", Today, true);
        ...
        if "Template Type" = "template type"::"Phone Pre-Screening Interview" then begin
            ...
            if Code = '' then
                code := NoSeriesMgt.GetNextNo(HRSetup."Phone Template Nos.", Today, true);
        ...
        if "Template Type" = "template type"::"Interview Scoresheet" then begin
            ...
            if Code = '' then
                code := NoSeriesMgt.GetNextNo(HRSetup."Scoresheet Template Nos.", Today, true);
