...
Table 69701 "PreScreen Header"
{
    ...
    begin
        ...
        if ("Document Type" = "document type"::"Phone Interview Report") then begin
            ...
            if "Document No." = '' then
                "Document No." := NoSeriesMgt.GetNextNo(HRSetup."Phone Interview Report Nos.", Today, true);
        ...
        if ("Document Type" = "document type"::"Ability Test Invitation") then begin
            ...
            if "Document No." = '' then
                "Document No." := NoSeriesMgt.GetNextNo(HRSetup."Ability Test Invitation Nos.", Today, true);
