...
Table 65037 "Project Budget Planning Line"
{
    ...
    fields
    {
        ...
        field(9;Quantity;Decimal)
        {
            ...
            var
                Delta: Decimal;
            begin
                /*IF GrantImplementationRequests.GET(Rec."Project Budget ID") THEN BEGIN
                ...
                "Total Cost (LCY)":=Quantity*"Direct Unit Cost (LCY)";
                ...
                "Total Cost":=Quantity*"Unit Cost";
                "Total Cost (LCY)":=Quantity*"Unit Price (LCY)";
        ...
        field(1004;"Unit Price";Decimal)
        {
            ...
            begin
                ...
                "Direct Unit Cost (LCY)":="Unit Price";
                "Unit Cost":="Unit Price (LCY)";
                "Total Cost":=Quantity*"Unit Price";
                "Total Cost (LCY)":=Quantity*"Unit Price (LCY)";
                //"Unit Price":="Unit Cost";
                "Unit Price (LCY)":="Unit Price";
                "Line Amount":=Quantity*"Unit Price";
                "Line Amount (LCY)":=Quantity*"Unit Price (LCY)";
                "Total Price":=Quantity*"Unit Price";
                "Total Price (LCY)":=Quantity*"Unit Price (LCY)";
            end;
        }
    ...
    var
        ...
        GrantImplementationRequests: Record "Grant Implementation Requests";
