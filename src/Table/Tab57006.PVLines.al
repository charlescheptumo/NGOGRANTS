    ...
    fields
    {
        ...
        field(8; Amount; Decimal)
        {
            ...
            begin
                ...
                "Amount (LCY)" := Amount;
                // "Amount (LCY)" := "Net Amount";
                if PVHeader."Document Type" = PVHeader."Document Type"::Imprest then begin
                    "Amount (LCY)" := "Net Amount";
                end;
                GetPaymentHeader;
                ...
                if PVHeader.FindSet then begin
                    ...
                    if PVHeader."Currency Code" <> '' then begin
                        ...
                        if PVHeader."Document Type" = PVHeader."Document Type"::Imprest then begin
                            "Amount (LCY)" := PaymentRounding("Net Amount");
                        end else
                            "Amount (LCY)" := PaymentRounding(Amount);
                end;
                //MESSAGE('%1',GetDate)
        ...
        field(14; "Applies to Doc. No"; Code[20])
        {
            ...
            begin
                Validate(Amount);
                PurH.Reset();
                PurH.SetRange("Document Type", PurH."Document Type"::Invoice);
                PurH.SetRange("No.", "Applies to Doc. No");
                if PurH.FindFirst() then begin
                    PVHeader.Reset();
                    PVHeader.SetRange(PVHeader."No.", No);
                    if PVHeader.FindFirst() then begin
                        PVHeader."Shortcut Dimension 1 Code" := PurH."Shortcut Dimension 1 Code";
                        PVHeader.Validate("Shortcut Dimension 1 Code");
                        PVHeader."Shortcut Dimension 2 Code" := PurH."Shortcut Dimension 2 Code";
                        PVHeader.Validate("Shortcut Dimension 2 Code");
                        PVHeader."Shortcut Dimension 3 Code" := PurH."Shortcut Dimension 3 Code";
        ...
        field(24; Type; Code[20])
        {
            ...
            // TableRelation = "Receipts and Payment Types1".Code;
        ...
        field(50001; Project; Code[20])
        {
            ...
            var
                ...
                "Total Budget Commitments": Decimal;
            begin
                ...
                IF JobRec.GET(Project) THEN BEGIN
                    ...
                    "Actual to Date" := JobRec."Actual Project Costs";
                    "Total Budget Commitments" := JobRec."PO Commitments" + JobRec."PRN Commitments" + JobRec."Store Requisition Commitments" + JobRec."Imprest Application Commitment";
                    "Available Funds" := "Project Budget" - JobRec."Actual Project Costs" - "Total Budget Commitments";
        ...
        field(50024; "Vote Item Desc."; Text[200])
        {
            ...
            begin
                PVHeader.Reset();
                PVHeader.SetRange("No.", PVHeader."No.");
                if PVHeader.findset() then begin
                    PVHeader."Type of Expense" := Rec."Vote Item Desc.";
                end
            end;
        }
        ...
        field(50035; "Actual Spent"; Decimal)
        {
        ...
        field(50037; "Receipt No."; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50038; Job; Code[50])
        {
            DataClassification = ToBeClassified;
        }

        field(50039; "Job Task No"; Code[30])
        {
            DataClassification = ToBeClassified;
        }

        field(50040; "Purpose"; Text[255])
        {
            DataClassification = ToBeClassified;
        }

        field(50041; "Claim Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50042; "Shortcut Dimension 3 Code"; Code[50])
        {
            CaptionClass = '1,2,3';
        ...
        field(50043; "Project Budget"; Decimal)
        {
            DataClassification = ToBeClassified;
