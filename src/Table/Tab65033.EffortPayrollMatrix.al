...
Table 65033 "Effort & Payroll Matrix"
{
    ...
    fields
    {
        field(1; "Project No"; Code[50])
        {
            ...
            trigger OnValidate()
            var
                ProjectJob: Record Job;
            begin
                ProjectJob.Reset;
                ProjectJob.SetRange("Project No", "Project No");
                if ProjectJob.Find('-') then begin
                    Customer := ProjectJob."Sell-to Customer Name";
                end
            end;
        }
        ...
        field(3; "Resource ID"; Code[50])
        {
            ...
            trigger OnValidate()
            begin
                if Emp.Get("Resource ID") then begin
                    "Employee No" := Emp."No.";
