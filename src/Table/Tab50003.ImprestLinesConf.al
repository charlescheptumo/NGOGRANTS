table 50003 "Imprest Lines Conf"
{
    Caption = 'Imprest Lines Conf';
    DataClassification = ToBeClassified;
    // DrillDownPageID = "Imprest Surrender Lines Conf";
    // LookupPageID = "Imprest Surrender Lines Conf";
    ...
    fields
    {
        ...
        field(50014; "Conference Date"; Date)
        {
