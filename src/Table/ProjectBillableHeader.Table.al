...
Table 65042 "Project Billable Header"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = if ("Project Type"=const("Fixed Price Billing")) Job."No." where ("Project Type"=const("Milestone-based"))
                            else if ("Project Type"=const("Time & Material")) Job."No." where ("Project Type"=const("Cost reimbursement"));
