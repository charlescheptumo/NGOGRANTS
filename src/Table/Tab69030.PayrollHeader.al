...
Table 69030 "Payroll Header"
{
    ...
    fields
    {
        ...
        {
            Editable = true;
            OptionCaption = 'Open,Pending Approval,Pending Prepayment,Approved,Rejected';
            OptionMembers = Open,"Pending Approval","Pending Prepayment",Approved,Rejected;
        }
        ...
        {
            OptionCaption = 'Contribution,Transfer-Ins,Interest,Payroll,Salary Voucher';
            OptionMembers = Contribution,"Transfer-Ins",Interest,Payroll,"Salary Voucher";
        }
        ...
        //     end;
        // }
        // field(495; "Job Task Name"; Text[200])
        // {
        ...
        //     FieldClass = FlowField;
        // }
        // field(496; "Job Task Budget"; Decimal)
        // {
        //     DataClassification = ToBeClassified;
        // }
        // field(497; "Job Task Remaining Amount"; Decimal)
        // {
        //     DataClassification = ToBeClassified;
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "No.", "Payroll Period", "payroll Month")
        {
    ...
    begin
        ...
        Currency := NoSetup."Payroll Currency";
