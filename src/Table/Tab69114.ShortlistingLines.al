...
Table 69114 "Shortlisting Lines"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionMembers = "Oral&Written",Apptitude,Closed;
        }
        ...
        field(18;"Starting  Gross Salary";Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(19;"Applicant Response Deadline";Date)
        {
            DataClassification = ToBeClassified;
        }
        field(20;"Requisition No.";Code[30])
        {
            DataClassification = ToBeClassified;
