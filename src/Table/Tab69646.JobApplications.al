...
Table 69646 "Job Applications"
{
    ...
    fields
    {
        ...
        field(26; "Specialization Area"; Code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Domain Area";
        }
        field(27; "Highest Academic Qualification"; Code[100])
        {
        ...
        field(69; Shortlist; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70; Longlist; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(71; "Invite Written Assessment"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(72; "Invite interview"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(73; "Second interview"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(74; "Offer Employment"; Boolean)
        {
            DataClassification = ToBeClassified;
    ...
    begin
        ...
        if "Application No." = '' then
            "Application No." := NoSeriesMgt.GetNextNo(HumanResourcesSetup."Job Application Nos", Today, true);
