...
Table 65022 "Grant Funding Application"
{
    ...
    fields
    {
        ...
        field(3; "FOA ID"; Code[100])
        {
            ...
            begin
                if FOA.Get("FOA ID") then begin
                    ...
                    "Application Due Date" := FOA."Application Due Date";
                    "Currency Code" := FOA."Currency Code";
                    "Requested Grant Amount" := FOA."Opportunity Amount";
                    "Requested Grant Amount(LCY)" := FOA."Opportunity Amount(LCY)";
                    "Concept Note" := FOA."Referenced Concept Note";
                    "Justification for Application" := FOA.Title;
                    "Phone No" := FOA."Funding Agency Phone";
                    "Grantor Name" := FOA."Funding Agency Name";
                    City := FOA."Funding Agency City";
                    "Grantor Admin Contact ID" := FOA."Issuing Organization";
                    Address := FOA."Funding Agency City";
                    "Phone No" := FOA."Funding Agency Phone";
                    City := FOA."Funding Agency City";
                    "Mobile Phone No" := FOA."Funding Agency Phone";
                    "Application Due Date" := FOA."Application Due Date";
                    "Application Submitted Date" := FOA."Application date";
                    "Estimated Award Date" := FOA."Expiration Date";
        ...
        field(6; "Opportunity  Title"; Text[255])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(9; "Justification for Application"; Text[500])
        {
            DataClassification = ToBeClassified;
        }
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Research Center Programs"."Program Code";

            trigger OnValidate()
            begin

                if researchprogram.Get(researchprogram.Code) then begin
                    "Primary Research Program ID" := researchprogram.Name;
        ...
        field(14; "Principal Investigator"; Code[50])
        {
            ...
            begin
                if Employee.Get("Principal Investigator") then begin
                    "Principal Investigator Name" := Employee.FullName;
                    "Research Center" := Employee."Department Code";
                end;
            end;
        }
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Not Started,Won,Lost';
            OptionMembers = "Not Started",Won,Lost;
        }
        ...
        field(26; "Grantor No."; Code[50])
        {
            ...
            begin
                if Customer.Get("Grantor No.") then begin
                    ...
                    "Grantor Research Contact ID" := Customer."Funding Contact ID";
                    "Grantor Research Reviewer" := Customer."Funding Contact Name";
        ...
        field(99; "Subcontract no"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(100; "Notice of Award no"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(101; "Invoice Code"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(102; "Principal Investigator Name"; Text[50])
        {
            Editable = false;
            FieldClass = Normal;
        }
        field(103; "SERU No."; Code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = Customer where("Funding Class" = const(Grant));
        ...
        field(104; "SERU Approval Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(105; "SERU Expiry Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(106; "SERU CRR Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        // field(107;"Grant_Admin Team Code";Code[10])
        // {
        //     CalcFormula = lookup("Application Grant Teams"."Team Code" where ("Application Code"=field("Application No")));
        //     FieldClass = FlowField;
        //     TableRelation = "Grant Teams";
        // }
        field(108; "Research Program Name"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(109; "Specific Research Area"; Text[1000])
        {
            DataClassification = ToBeClassified;
        }
        field(110; "Study Type"; Code[20])
        {
            DataClassification = ToBeClassified;
            //   TableRelation = "Board Meeting Comments";
        }
        field(111; Score; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(112; "Total Budget Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(113; "Concept Note"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Funding Opportunity" where("Call Type" = const("Call for Concept Notes"));
        }
        field(114; "Short Title"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(115; "Funds confirmed"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(116; "Funds confirmed by"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(117; "Problem Statement"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(118; "SERU duration"; DateFormula)
        {
            DataClassification = ToBeClassified;
        }
        field(119; "Total Requested Amount"; Decimal)
        {
            FieldClass = Normal;
        }
        field(120; County; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(121; Designation; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(122; "Job ID"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        if "Application No" = '' then begin
            if not ("Call Type" in ["call type"::"Call for Concept Notes"]) then begin
                GrantsSetup.Get;
                ...
                "Application No" := NoSeriesMgt.GetNextNo(GrantsSetup."Grant Proposal Nos", WorkDate(), true);
            end;
            if "Call Type" in ["call type"::"Call for Concept Notes"] then begin
                GrantsSetup.Get;
                // GrantsSetup.TestField("Call for Concept Notes Nos");
                // NoSeriesMgt.InitSeries(GrantsSetup."Call for Concept Notes Nos",xRec."No. Series",0D,"Application No","No. Series");
            end;
        end;
