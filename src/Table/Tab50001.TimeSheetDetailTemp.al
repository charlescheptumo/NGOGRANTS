table 50001 "Time Sheet Detail Temp"
{
    Caption = 'Time Sheet Detail Temp';
    fields
    {
    ...
    local procedure OnAfterCopyFromTimeSheetLine(var TimeSheetDetail: Record "Time Sheet Detail Temp"; TimeSheetLine: Record "Time Sheet Line")
    begin
    end;
