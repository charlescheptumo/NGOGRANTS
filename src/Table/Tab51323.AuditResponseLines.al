...
Table 51323 "Audit Response Lines"
{
    ...
    fields
    {
        ...
        field(9;"Response Code";Code[30])
        {
            TableRelation = if ("Question Type"=filter("Closed-Ended")) "Answers Setup";
        }
        field(10;"Response Description";Blob)
        {
        }
        field(11;Attachment;Boolean)
        {
        }
    }
    ...
    var
        AnswersSetup: Record "Answers Setup";
}
