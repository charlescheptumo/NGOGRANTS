...
Table 69706 "Candidate Selection Header"
{
    ...
    begin
        ...
        if "Document Type" = "document type"::"Candidate Shortlisting" then begin
            ...
            if "Document No." = '' then
                "Document No." := NoSeriesMgt.GetNextNo(HRSetup."Shortlisting Voucher Nos.", Today, true);
        ...
        if "Document Type" = "document type"::"Consolidated Interview Report" then begin
            ...
            if "Document No." = '' then
                "Document No." := NoSeriesMgt.GetNextNo(HRSetup."Interview Report Nos.", Today, true);
        ...
        if "Document Type" = "document type"::"Interview Invitation" then begin
            ...
            if "Document No." = '' then
                "Document No." := NoSeriesMgt.GetNextNo(HRSetup."Interview Invitation Nos.", Today, true);
