page 69999 "DBSL Accountant Role Center"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(PaymentVouchersCues; "M&E  Activities")
            {
                ApplicationArea = Basic, Suite;
            }
    ...
    actions
    {
        area(reporting)
        {
            group("G/L Reports")
            {
                ...
                action("&G/L Trial Balance 2")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = '&G/L Trial Balance 2';
                    Image = "Report";
                    RunObject = Report "Trial Balance 2";
                    ToolTip = 'View, print, or send a report that shows the balances for the general ledger accounts, including the debits and credits. You can use this report to ensure accurate accounting practices.';
                }
                action("&G/L Trial Balance Total")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = '&G/L Trial Balance Total';
                    Image = "Report";
                    RunObject = Report "Trial Balance Total";
                    ToolTip = 'View, print, or send a report that shows the balances for the general ledger accounts, including the debits and credits. You can use this report to ensure accurate accounting practices.';
                }
                action("&G/L Trial Balance Total Add Curr")
                {
                    ApplicationArea = Basic;
                    Caption = '&G/L Trial Balance Total Add Curr';
                    Image = "Report";
                    RunObject = Report "Trial Balance Total Add Curr";
                    ToolTip = 'View, print, or send a report that shows the balances for the general ledger accounts, including the debits and credits. You can use this report to ensure accurate accounting practices.';
                }
                ...
                action("Summary Transactions Per User")
                {
                    ApplicationArea = Suite;
                    Caption = 'Summary Transactions Per User';
                    Image = "Report";
                    RunObject = Report "Summary Transaction Report";
                }
                action("General Ledger Entry")
                {
                    ApplicationArea = Basic;
        ...
        area(embedding)
        {
            ...
            action(Projects)
            {
                ...
                ToolTip = 'Set up project budgets';
            }
            action(AdvEmployees)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Advance Employees';
                Image = Customer;
                RunObject = Page "Customer List";
                RunPageLink = "Funding Class" = filter(Employee);
                ToolTip = 'View or edit detailed information for the employees that receive advances. From each employee card, you can open related information.';
            }
            action(Customers)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Donors/Co-Partners';
                Image = Customer;
                RunObject = Page "Customer List";
                RunPageLink = "Funding Class" = filter(Grant);
                ToolTip = 'View or edit detailed information for the donors. From each donor card, you can open related information.';
            }
            action(Vendors)
            {
                ApplicationArea = Basic, Suite;
            ...
            action("Sales Orders")
            {
                ...
                ToolTip = 'Create Sales orders to mirror purchase documents that vendors send to you. This enables you to record the cost of purchases and to track accounts payable. Posting Sales orders dynamically updates inventory levels so that you can minimize inventory costs and provide better customer service. Sales orders allow partial receipts, unlike with Sales invoices, and enable drop shipment directly from your vendor to your customer. Sales orders can be created automatically from PDF or image files from your vendors by using the Incoming Documents feature.';
            }
            ...
            action("Sales Invoices")
            {
                ...
                ToolTip = 'Create Sales invoices to mirror purchase documents that Donors send to you. This enables you to record the cost of Sales and to track accounts receivables. Posting Sales invoices dynamically updates inventory levels so that you can minimize inventory costs and provide better customer service. Sales invoices can be created automatically from PDF or image files from your vendors by using the Incoming Documents feature.';
            }
            action("EC Sales List")
            {
                ApplicationArea = VAT;
            ...
            action(Employee)
            {
                ...
                RunObject = Page "Customer List";
                RunPageLink = "Funding Class" = filter(Employee);
                ToolTip = 'View or edit detailed information for the donors that you trade with. From each customer card, you can open related information, such as sales statistics and ongoing orders, and you can define special prices and line discounts that you grant if certain conditions are met.';
            }
        }
        area(sections)
        {
            ...
            group(Journals)
            {
                ...
                action(PaymentsJournals)
                {
                    ...
                    RunPageView = WHERE("Template Type" = CONST(Payments),
                                        Recurring = CONST(false));
                    ToolTip = 'Post any payments-related transaction directly to a customer, bank, or general ledger account instead of using dedicated documents. You can post all types of financial payments transactions. Note that you cannot post item quantities with a payments journal.';
                }
                action(CashReceiptsJournals)
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Receipts Journals';
                    RunObject = Page "General Journal Batches";
                    RunPageView = WHERE("Template Type" = CONST("Cash Receipts"),
                                        Recurring = CONST(false));
                    ToolTip = 'Post any receipt-related transaction directly to a customer, bank, or general ledger account instead of using dedicated documents. You can post all types of financial receipt transactions. Note that you cannot post item quantities with a receipt journal.';
                }
            ...
            group("Cash Management")
            {
                ...
                action(ApprovedBankAccountReconciliations)
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Bank Account Reconciliations';
                    Image = BankAccountRec;
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Approved Bank Reconciliations";
                    ToolTip = 'Reconcile bank accounts in your system with bank statements received from your bank.';
                }
            }
            ...
            group("Funds Management")
            {
                ...
                action(PostedPaymentVouchers)
                {
                    ...
                    ToolTip = 'Paid Vendors and Suppliers.';
                }
                action(NewReceipts)
                {
                    ApplicationArea = Basic, Suite;
                    ...
                    RunObject = Page "New Receipts";
                    ToolTip = 'Receipts Funds from Donors';
                }
                action(Receipts)
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Direct Income Vouchers")
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Direct Income Vouchers';
                    RunObject = Page "Direct Income Voucher List";
                    ToolTip = 'Receipts Funds from Donors while indicating the Earned Income Account.';
                }
                ...
                action(PettyCashRequisition)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Petty Cash Requisition";
                    ToolTip = 'Petty Cash Requisition';
                }
                ...
                action(AProvedPettyCashSurrenders)
                {
                    ApplicationArea = Basic, Suite;
                ...
                action(PostedPettyCashVouchers)
                {
                    ...
                    ToolTip = 'Posted Petty Cash Surrenders';
                }
                action("Imprest Memos")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Advance request memos';
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Imprest Memos";
                    Visible = false;
                    ToolTip = 'Advance request Memos.';
                }
                action("Approved Imprest Memos")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Advance request memos';
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = Page "Approved Imprest Memos";
                    Visible = false;
                    ToolTip = 'Approved Advance request memos';
                }
                ...
                action("Posted Imprest Requisitions")
                {
                    ...
                    ToolTip = 'Posted Advance requests.';
                }
                ...
                action("Posted Imprest Surrenders ")
                {
                    ...
                    ToolTip = 'Posted Advance Surrenders .';
                }
            ...
            group("Reportings")
            {
                ...
                action("Donor Summary Aging Analysis")
                {
                    ApplicationArea = Basic;
                    Caption = 'Donor Summary Aging Analysis';
                    RunObject = Report "Customer - Summary Aging";
                }
                action("Donor Detailed Aging Analysis")
                {
                    ApplicationArea = Basic;
                    Caption = 'Donor Detailed Aging Analysis';
                ...
                action("Vendor Summary Aging Analysis")
                {
                    ApplicationArea = Basic;
                    Caption = 'Vendor Summary Aging Analysis';
                ...
                action("Trial Balance2")
                {
                    ApplicationArea = Basic;
                    Caption = 'Trial Balance 2';
                    RunObject = Report "Trial Balance 2";
                }
                action("Trial Balance Total")
                {
                    ApplicationArea = Basic;
                    Caption = 'Trial Balance Total';
                    RunObject = Report "Trial Balance Total";
                }
                action("Trial Balance Total Add Curr")
                {
                    ApplicationArea = Basic;
                    Caption = 'Trial Balance Total Add Curr';
                    RunObject = Report "Trial Balance Total Add Curr";
                }
            ...
            group("Self Service")
            {
                ...
                action(ShortListedCandidates)
                {
                    ...
                    RunPageLink = Shortlist = const(true), Directorate = const('OPERATION'), Department = const('FINANCE');
