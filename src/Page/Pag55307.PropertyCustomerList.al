...
Page 55307 "Property Customer List"
{
    ...
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Approve,New Document,Request Approval,Implementing Partner';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the Implementing Partner''s name. This name will appear on all sales documents for the Implementing Partner. You can enter a maximum of 50 characters, both numbers and letters.';
                }
                ...
                field("Address"; Rec.Address)
                {
                    ...
                    ToolTip = 'Specifies from which location sales to this Implementing Partner will be processed by default.';
                }
        ...
        area(reporting)
        {
            group(Reports)
            {
                ...
                group(SalesReports)
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Implementing Partner - Top 10 List';
                        Image = "Report";
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Implementing Partner - Sales List';
                        Image = "Report";
                        Visible = false;
                ...
                group(FinanceReports)
                {
                    ...
                    {
                        ApplicationArea = Advanced;
                        Caption = 'Implementing Partner - Balance to Date';
                        Image = "Report";
                    ...
                    {
                        ApplicationArea = Suite;
                        Caption = 'Implementing Partner - Trial Balance';
                        Image = "Report";
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Implementing Partner - Detail Trial Bal.';
                        Image = "Report";
                    ...
                    {
                        ApplicationArea = Advanced;
                        Caption = 'Implementing Partner - Summary Aging';
                        Image = "Report";
                    ...
                    {
                        ApplicationArea = Advanced;
                        Caption = 'Implementing Partner - Detailed Aging';
                        Image = "Report";
                    ...
                    {
                        ApplicationArea = Suite;
                        Caption = 'Implementing Partner - Payment Receipt';
                        Image = "Report";
            ...
            group(General)
            {
                ...
                {
                    ApplicationArea = Advanced;
                    Caption = 'Implementing Partner List';
                    Image = "Report";
                ...
                {
                    ApplicationArea = Advanced;
                    Caption = 'Implementing Partner Register';
                    Image = "Report";
