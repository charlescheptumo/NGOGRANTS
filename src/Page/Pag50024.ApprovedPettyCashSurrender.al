page 50024 "Approved Petty Cash Surrender"
{
    ...
    SourceTableView = sorting("No.") order(descending) where("Payment Type" = const("Petty Cash Surrender"),
                            Surrendered = const(false), Status = const(Approved));
    UsageCategory = Lists;
