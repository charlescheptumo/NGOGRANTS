page 50005 "GL Entry Update Draft"
{
    PageType = ListPlus;
    SourceTable = "Update GL Entries";
    ...
    layout
    {
        area(Content)
        {
            ...
            part(DimensionCorrectionsPage; "GL Correction Changes")
            {
                Editable = EditAllowed;
                ApplicationArea = All;
                Caption = 'GL Entries Changes';
                UpdatePropagation = SubPart;
                SubPageLink = "GL Correction Entry No." = field("Entry No.");
            }
