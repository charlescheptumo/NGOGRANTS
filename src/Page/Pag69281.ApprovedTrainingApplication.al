...
Page 69281 "Approved Training Application"
{
        ...
        if UserSetup.FindSet then begin
            if UserSetup."Accounts User" = true then begin
                ...
                if PurchaseHeader.FindSet then begin
                    ...
                    HeaderNo := NoSeriesManagement.GetNextNo(PurchasesPayablesSetup."Purchase Requisition Nos.", WorkDate(), true);
    ...
    begin
        ...
        LeaveNo := NoSeriesManagement.GetNextNo(HRSetup."Leave Application Nos.", WorkDate(), true);
