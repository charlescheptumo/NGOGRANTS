...
Page 69162 "Employee Card-HR1"
{
    ...
    begin
        ...
        // Rec."No." := NoSeriesMgt.GetNextNo(HumanResSetup."Employee Nos.", Today, true);
    ...
    //     HumanResSetup.Get();
    //     HumanResSetup.TestField("Employee Nos.");
    //     if NoSeriesMgt.SelectSeries(HumanResSetup."Employee Nos.", xRec."No. Series", Rec."No. Series") then begin
