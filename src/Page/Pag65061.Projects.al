    ...
    actions
    {
        ...
        area(reporting)
        {
            action("Job Actual to Budget")
            {
                ...
                ToolTip = 'Compare budgeted and usage amounts for selected projects. All lines of the selected job show quantity and total cost.';
            }
            action("Job Analysis")
            {
                ApplicationArea = Jobs;
