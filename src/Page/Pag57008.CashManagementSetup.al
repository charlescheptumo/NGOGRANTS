    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Petty Cash Bank"; Rec."Petty Cash Bank")
                {
                    ToolTip = 'Specifies the value of the Petty Cash Bank field.';
                }
                ...
                field("Workplan No. Series";Rec."Workplan No. Series"){
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Workpan No. Series Nos field.';
                }
            }
