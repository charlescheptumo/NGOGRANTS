    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Contract Duration Code';
                }
                ...
                field("Invoice Currency Code"; Rec."Invoice Currency Code")
                {
                    ...
                    ToolTip = 'Specifies the currency code you want to apply when creating invoices for a project. By default, the invoice currency code for a job is based on what currency code is defined on the customer card.';
                }
        ...
        area(factboxes)
        {
            ...
            part(Control1902136407; "Job No. of Prices FactBox")
            {
                ...
                Visible = true;
                Caption = 'Budget No. of Prices FactBox';
            }
            part(Control1905650007; "Job WIP/Recognition FactBox")
            {
                ...
                SubPageLink = "No." = field("No."),
                              ...
                              "Planning Date Filter" = field("Planning Date Filter");
                Visible = false;
                Caption = 'Budget WIP/Recognition FactBox';
            }
    ...
    actions
    {
        area(navigation)
        {
            group("&Job")
            {
                ...
                action(JobPlanningLines)
                {
                    ...
                    ToolTip = 'View all planning lines for the budget. You use this window to plan what items, resources, and general ledger expenses that you expect to use on a job (Budget) or you can specify what you actually agreed with your customer that he should pay for the job (Billable).';
            ...
            group("Research Project")
            {
                ...
                action(MilestonesLines)
                {
                    ...
                    PromotedCategory = Process;
                    ShortCutKey = 'Shift+Ctrl+P';
                    ToolTip = 'View all planning lines for the budget. You use this window to plan what items, resources, and general ledger expenses that you expect to use on a budget or you can specify what you actually agreed with your customer that he should pay for the job (Billable).';
        ...
        area(processing)
        {
            group("&Copy")
            {
                ...
                {
                    ApplicationArea = Jobs;
                    Caption = 'Copy Budget Tasks &from...';
                    Ellipsis = true;
                    Image = CopyToTask;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Open the Copy Budget Tasks page.';
                ...
                {
                    ApplicationArea = Jobs;
                    Caption = 'Copy Budget Tasks &to...';
                    Ellipsis = true;
                    Image = CopyFromTask;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Open the Copy Budget To page.';
            ...
            group(ActionGroup26)
            {
                ...
                action("<Action82>")
                {
                    ...
                    //PromotedCategory = Process;
                    ToolTip = 'Run the Budget Calculate WIP batch job.';
                ...
                action("<Action83>")
                {
                    ...
                    //PromotedCategory = Process;
                    ShortCutKey = 'F9';
                    ToolTip = 'Run the Budget Post WIP to G/L batch job.';
        ...
        area(reporting)
        {
            ...
            {
                ApplicationArea = Suite;
                Caption = 'Budget Actual to Budget';
                Image = "Report";
                Promoted = true;
            ...
            action("Job Analysis")
            {
                ...
                Promoted = true;
                PromotedCategory = "Report";
                // RunObject = Report "Project Analysis Cust";
                RunObject = Report "Job Analysis";
                ToolTip = 'Analyze the Budget, such as the budgeted prices, usage prices, and billable prices, and then compares the three sets of prices.';
            }
            ...
            //     ToolTip = 'Analyze the Budget, such as the budgeted prices, usage prices, and billable prices, and then compares the three sets of prices.';
            // }
            // action("Job - Planning Lines2")
            // {
            //     ApplicationArea = Basic;
            //     Caption = 'Budget - Planning Lines 2';
            //     Image = "Report";
            //     Promoted = true;
            //     PromotedCategory = "Report";
            //     Visible = false;
            ...
            {
                ApplicationArea = Suite;
                Caption = 'Budget - Suggested Billing';
                Image = "Report";
                Promoted = true;
                PromotedCategory = "Report";
                Visible = false;
                RunObject = Report "Job Suggested Billing";
                ToolTip = 'View a list of all project, grouped by customer, how much the customer has already been invoiced, and how much remains to be invoiced, that is, the suggested billing.';
            }
            ...
            action(SendApprovalRequest)
            {
                ...
                var
                    VarVariant: Variant;
                //WF: Codeunit IntCodeunit;
                begin

                    // if WF.IsJobEnabled(Rec) then
                    //     wf.OnSendJobsforApproval(Rec);
