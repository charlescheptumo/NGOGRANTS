    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    // TableRelation = "Procurement Plan Lines"."PP Line No";
                    //Visible = false;
                }
                field(Job; Rec.Job)
                {
    ...
    actions
    {
            ...
            group("Purchase Requisition")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(Database::"Purchase Header", DocType, Rec."No.");
                        ApprovalEntries.Run;
                    end;
                }
                action("Co&mments")
        ...
        area(processing)
        {
            ...
            group(ActionGroup21)
            {
                ...
                //     begin
                //         HRPortal.fncreatePurchaseRequisition('APHFEXEC0001', '', 1, 'CLEANING', 'FY23', '20120', 0, 'TEST', 'AC', 'FC 21005', 34);
                //     end;
                // }
            }
            group("F&unctions")
