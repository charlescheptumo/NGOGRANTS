page 95397 "Approved Bank Reconciliations"
{
    ApplicationArea = All;
    Caption = 'Approved Bank Reconciliations';
    PageType = List;
    CardPageId = "Approved Bank Reconciliation";
    SourceTable = "Bank Acc. Reconciliation";
    SourceTableView = where("Statement Type" = const("Bank Reconciliation"), Status = const(Released));
    // PromotedActionCategories = 'New,Process,Report,Approvals,Atchments,Comment,Actions,Navigate,Home';
