...
Page 69029 "Payroll Header"
{
    ...
    PromotedActionCategories = 'New,Process,Report,Attachments,Approvals,Comments';
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ToolTip = 'This is the currency in which the payroll is calculated. It is set on the human resources setup under the payroll currency field.';
                    // Editable = false;
                }
                ...
                field("Job Task No."; Rec."Job Task No.")
                {
                    ...
                    ToolTip = 'Specifies the value of the Budget activity code field.';
                    Visible = false;
                }
        ...
        area(navigation)
        {
            group(ActionGroup16)
            {
                ...
                action("Master Roll ")
                {
                    ...
                    begin
                        emp.SetFilter(emp."Pay Period Filter", Format(Rec."Payroll Period"));
                        Report.Run(Report::"Employee Master Roll", true, true, emp)
                    end;
                }
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::"Salary Voucher";
    end;
    ...
    var
        ...
        Text0002: label 'You cannot Cancel document No. %1. Documents can only be Cancelled for Approval by initiators ';
