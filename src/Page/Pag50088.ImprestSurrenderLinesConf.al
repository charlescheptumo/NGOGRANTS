page 50088 "Imprest Surrender Lines Conf"
{
    ApplicationArea = Basic;
    Caption = 'Imprest Surrender Lines Conf';
    PageType = ListPart;
    SourceTable = "Imprest Lines Conf";
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Conference Date field.';
                }
