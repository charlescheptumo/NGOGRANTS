...
{
    Caption = 'Implementing Partner Card';
    PageType = Card;
    PromotedActionCategories = 'New,Process,Report,New Document,Approve,Request Approval,Portal,Navigate,Implementing Partner';
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("No."; Rec."No.")
                {
                    ...
                    Caption = 'Implementing Partner No';
                ...
                field("Balance (LCY)"; Rec."Balance (LCY)")
                {
                    ...
                    Caption = 'Allocated Funds Balance';
            ...
            group(Invoicing)
            {
                ...
                group(PostingDetails)
                {
                    ...
                    field("Vendor Posting Group"; Rec."Vendor Posting Group")
                    {
                        ApplicationArea = Basic, Suite;
                        Importance = Promoted;
                        Caption = 'Implementing Partner Posting Group';
                        ShowMandatory = true;
                ...
                group(PricesandDiscounts)
                {
                    ...
                    // field("Vendor Price Group"; Rec."Vendor Price Group")
                    // {
                    //     ApplicationArea = Basic, Suite;
                    //     Importance = Promoted;
                    //     Visible = false;
        ...
        area(factboxes)
        {
            part(Control149; "Customer Picture")
            {
                ApplicationArea = Basic, Suite;
                SubPageLink = "No." = field("No.");
                Caption = 'Implementing Partner Picture';
    ...
    actions
    {
        ...
        area(creation)
        {
            action(CreateonPortal)
            {
                ApplicationArea = All;
                Caption = 'Generate Portal Credentials';
                Image = Approve;
                Promoted = true;
                PromotedCategory = Category7;
                PromotedIsBig = true;
                ...
                trigger OnAction()
                var
                    Erecruit: Codeunit eRecruitment;
                begin
                    Rec.TestField("E-Mail");
                    erecruit.FnSendIPPassword(Rec."E-Mail", Rec."No.");
                end;
            }
