                ...
                group("Create as")
                {
                    ...
                    action(CreateVendor)
                    {
                        ...
                        var
                            ...
                            eprocurementCodeunit: Codeunit EProcurementCodeunit;
                        begin
                            Rec.CreateVendor;
                            eprocurementCodeunit.FnCreateApplicantAccountRequest(rec."E-Mail");
                        end;
                    }
                    action(PortalUser)
                    {
                        ...
                        Caption = 'Portal User';
                        Image = Vendor;
                        ToolTip = 'Create the contact as a portal user.';
