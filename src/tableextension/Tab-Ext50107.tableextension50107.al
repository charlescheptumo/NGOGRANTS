...
TableExtension 50107 "tableextension50107" extends "Human Resources Setup"
{
    fields
    {
        ...
        field(69638; "Exit voucher Nos"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(69639; "Exit HandOver Nos"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(69640; "Payroll Currency"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = Currency;
        }
        field(69641; "Leave Periods"; Option)
        {
            OptionMembers = Monthly,Yearly;
        }
        field(69642; "Offer Nos"; Code[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
