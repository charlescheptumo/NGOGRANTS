codeunit 95001 ERecruitmentCodeunit
{
    trigger OnRun()
    begin
    ...
    procedure FnRegistration(firstname: Text; lastname: Text; email: Text[400]; phoneNumber: Text) status: Text
    var
    ...
    procedure FnApplicantProfileRegistration(prefix: Integer; applicantNumber: Text; surname: Text; firstname: Text; othernames: Text; nationality: Text; countryOfResidence: Text; mobilephonenumber: Text; disabilitycertificate: Code[50]; disabilitysummary: Text[50]; isdisable: Boolean; SkillsandCompetence: Text) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        ...
        if Applicant.FindSet then begin
            ...
            // Applicant."Ethnic Group" := ethnicity;
            Applicant.Nationality := nationality;
            Applicant."Country of Residence" := countryOfResidence;
            Applicant."Mobile Phone No." := mobilephonenumber;
            //Applicant."NHIF No" := nhif;
            // Applicant."NSSF No" := nssf;
            //Applicant."KRA Pin" := krapin;
    ...
    procedure FnAcademicQualifications(applicantNumber: Text; educationlevel: Integer; institutionname: Text; qualificationtitle: Text; graduationyear: Text) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    procedure FnUpdateAcademicQualifications(applicantNumber: Text; EntryNumber: Integer; educationlevel: Integer; institutionname: Text; qualificationtitle: Text; graduationyear: Text) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    //     exit(status);
    // end;
    procedure FnProffessionalQualifications(applicantNumber: Text; institutionname: Text; country: Text; registrationNumber: Text; MembershipType: Text; graduationyear: Text) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        ...
        //JobApplicantsQualification."Proffessional Qualifications" := educationlevel;
        JobApplicantsQualification."Institution/Company" := institutionname;
        JobApplicantsQualification."Qualification Category" := JobApplicantsQualification."qualification category"::"Professional Bodies";
        JobApplicantsQualification.Country := country;

        // JobApplicantsQualification."Specialized Domain Area" := specializationarea;
        // JobApplicantsQualification."Attained Score" := attainedscore;
        JobApplicantsQualification."Completion Year" := graduationyear;
        JobApplicantsQualification.Type := JobApplicantsQualification.Type::External;
        JobApplicantsQualification."Institution/Company" := institutionname;
        // JobApplicantsQualification."From Date" := startdate;
        // JobApplicantsQualification."To Date" := enddate;
    ...
    begin
        ...
        ApplicationQualification."Qualification Category" := ApplicationQualification."qualification category"::"Professional Bodies";
    ...
    procedure FnWorkExperience(applicantNumber: Text; employerName: Text; jobdesignation: Text; employmentstartdate: DateTime; employmentenddate: DateTime; experienceyears: Text; dutiesresponsibilities: Text; specializationArea: Text; employmentType: Integer; onGoing: Boolean) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        JobApplicantsQualification.Init;
        JobApplicantsQualification."Candidate No." := applicantNumber;
        JobApplicantsQualification.Description := jobdesignation;
        JobApplicantsQualification."Institution/Company" := employerName;
        JobApplicantsQualification."Qualification Category" := JobApplicantsQualification."qualification category"::Experience;
        ...
        JobApplicantsQualification."Specialized Domain Area" := specializationArea;
        JobApplicantsQualification."Employment Type" := employmentType;
        JobApplicantsQualification.Ongoing := onGoing;
    ...
    procedure FnCandidateReferees(appplicantNumber: Text; title: Text; surname: Text; firtsname: Text; contactdesignations: Text; emailaddress: Text; phonenumber: Text; relationship: Text) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        ...
        Employee_ApplicantReferees."Document Type" := Employee_ApplicantReferees."document type"::"Job Applicant";
        //Employee_ApplicantReferees."Rererence Type" := refereetype;
        Employee_ApplicantReferees.Name := surname + ' ' + firtsname;
        Employee_ApplicantReferees."Designation/Title" := contactdesignations;
        //Employee_ApplicantReferees.Institution := institution;        
        Employee_ApplicantReferees."Phone No." := phonenumber;
        // Employee_ApplicantReferees."Country/Region Code" := country;
    ...
    procedure FnUpdateCandidateReferees(entryNo: Integer; appplicantNumber: Text; title: Text; surname: Text; firtsname: Text; contactdesignations: Text; emailaddress: Text; phonenumber: Text; relationship: Text) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        ...
        if Applicant.FindSet then begin
            ...
            status := 'profileincomplete*Candidate profile was not successfully completed.Kindly Complete your Profile before applying for any Position.';
        end;
    end;
    ...
    begin
        ...
        LoginDetails := '<br> We have also created your portal access account with the following login credentials:' +
                          ...
                          'APHF E-Recruitment Portal and complete your Profile';
        ...
        ActivationDetails := '<br> Once you access our portal, you shall be able to complete the Confidential Applicant section ' +
                            ...
                            '<br> <br><a href="https://careers.aphf.africa/">E-Recruitment Portal Link</a></br>';
        if CustEmail = '' then exit;

        emailhdr := 'APHF e-Recruitment Account Activation - [' + ApplicantRequest."No." + '])';
    ...
    var
        ...
        DocumentAttachment: Record "Document Attachment";
        RecordLink: Record "Record Link";
        JobAppli: Record "Job Applications";
    begin
        // Record Links Attachment on the Applications -Obadiah Korir
        if RecordLink."Link ID" = 0 then begin
            RecordLink.URL1 := FileLink;
            ...
            RecordLink."Record ID" := RecordIDNumber;
            JobAppli.Reset();
            if JobAppli."Candidate No." = Applicant."Candidate No." then begin
                RecordIDNumber := JobAppli.RecordId;
                RecordLink."Record ID" := RecordIDNumber;
            end;
            RecordLink."Record ID" := RecordIDNumber;
            if RecordLink.Insert(true) then begin
    ...
    begin
        ...
        if uploadedSharepointDocs.insert(true) then begin
            AddCandidateLinks(appNo, fileName, fileLink);
    ...
    procedure AddCandidateLinks(applicationNo: Code[50]; filename: Text; sharepointlink: Text) status: Text
    var
        applicant: Record Applicant;
        RecordLink: Record "Record Link";
        RecordIDNumber: RecordID;
    begin
        ...
        if RecordLink."Link ID" = 0 then begin
            ...
            RecordLink.Created := CreateDatetime(Today, Time);
            applicant.Reset;
            applicant.SetRange("Candidate No.", applicationNo);
