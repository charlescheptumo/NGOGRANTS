...
Codeunit 57003 "Payments"
{
    ...
    begin
        with Payments do begin
            ...
            // if ApprovalsMgmt.IsPaymentsApprovsalsWorkflowEnabled(Payments) and (Payments.Status = Payments.Status::Open) then
            // Error(Text002);

            // Codeunit.Run(Codeunit::Payments, Payments);//commended by morris for APHF//30.03.2023//added next code
