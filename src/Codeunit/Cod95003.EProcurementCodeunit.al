codeunit 95003 EProcurementCodeunit
{
    trigger OnRun()
    begin
    ...
    begin
        ...
        if Contact.FindSet then begin
            ...
            Body := 'Dear, ' + Contact."Name 2" + ', this email is to acknowledge your request for registration as a supplier. The APHF procurement team will review your request and get back to you as soon as possible.';
    ...
    begin
        ...
        if procurementSetup."Default Proc Email Contact" = '' then begin
            Error('Please Contact the IT Admin to specify the Procurement Manager E-mail address under Procurement Setup page!!');
        end else begin
            if Contact.FindSet then begin
    ...
    begin
        ...
        if objPurhcaseLinesDetails.FindSet then begin
            objPurhcaseLinesDetails."VAT Prod. Posting Group" := 'EXEMPT';
            objPurhcaseLinesDetails.Validate("Direct Unit Cost Inc. VAT", costexlvat);
            objPurhcaseLinesDetails."VAT Prod. Posting Group" := 'VAT0';
            objPurhcaseLinesDetails.Validate("Direct Unit Cost", costexlvat);
            if objPurhcaseLinesDetails.Modify(true) then begin
                insertstatus := 'success*Your Pricing Details was saved successfully!';
            end else begin
                insertstatus := 'danger*Your Pricing Details was not successfully!';
    ...
    begin
        ...
        // '<BR>Africa Public Health Foundation'+
                ...
                if ApplicantProfile.Insert(true) then begin
                    ...
                    if not PortalUSer.FindSet then begin
                        ...
                        if PortalUSer.Insert(true) then begin
                            ...
                            Subject := 'EProcurement Account Creation';
                            Body := 'Dear, ' + PortalUSer."Full Name" + ' your password for the account: ' + ' <strong>' + PortalUSer."Authentication Email" + '</strong> has been created successfully. Kindly use the password below to access your account<br> <strong>Password: ' + PortalUSer."Password Value" + '</strong> <br>';
                            Body := Body + ' ' + 'Kind Regards, Africa Public Health Foundation' + '<br><br>';
                            Body := Body + '[This email is automated. Kindly do not reply to it]<br><br>';
                            SMTPMail.Create(Contact."E-Mail", Subject, Body, true);
                            Smail.Send(SMTPMail, Enum::"Email Scenario"::Default);
